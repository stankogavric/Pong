...
int main(int argc, char* argv[])
{
    ...
    // provjera da li postoji dzojstik
    ...
    while(!quit)
    {
        ...
        // racunanje FPS-a (broj frejmova u sekundi)
        ++frames;
        ...
        // provjera kolizije (sudara) s granicama
        if(b.y < 0)
        {
            b.y = 0;
            b.vy *= -1;
        ...
        // provjera kolizije (sudara) s igracem
